...
export async function getShortsHandler(): Promise<PrismMediaItem[]> {
  return new Promise((resolve, reject) => {
    const options = {
      hostname: "localhost",
      port: 3001,
      path: "/api/admin/v1/get-all-shorts",
      method: "GET",
    };
...
export async function createShortHandler(
  ...
  return new Promise((resolve, reject) => {
    ...
    const options = {
      hostname: "localhost",
      port: 3001,
      path: "/api/admin/v1/create-short",
      method: "POST",
      headers: {
...
export async function deleteShortHandler(
  ...
  return new Promise((resolve, reject) => {
    const mediaItemId = short.mediaItemId;

    const options = {
      hostname: "localhost",
      port: 3001,
      path: `/api/admin/v1/delete-short?mediaItemId=${mediaItemId}`,
      method: "DELETE",
    };
...
export async function updateShortHandler(
  ...
  return new Promise((resolve, reject) => {
    ...
    const options = {
      hostname: "localhost",
      port: 3001,
      path: "/api/admin/v1/update-short",
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "Content-Length": data.length,
